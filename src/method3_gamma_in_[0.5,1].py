...
# Part 0: Evaluate the adopted parameters at gamma = 0.75
gamma = 0.75
...
plot([model0], [gamma], method, 20000, [mse0], None, None, epochs, variable='gamma')

# Part 1: Compare the results for different gammas
gammas = [0.51, 0.55, 0.6, 0.75, 0.9, 0.95, 1]
models, mses = [], []
...
# Part 2: Parameter testing (taking gamma = 0.75 as an example)
